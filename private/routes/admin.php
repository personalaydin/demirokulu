...
//Article
Route::panelResource('article', 'ArticleController', [
    'sortable' => true, 
    'softDelete' => true,
]);

//Video
Route::panelResource('video', 'VideoController', [
    'sortable' => true, 
    'softDelete' => true,
]);

//Videoparent
Route::panelResource('videoparent', 'VideoparentController', [
    'sortable' => true, 
    'softDelete' => true,
]);

//Broadcast
Route::panelResource('broadcast', 'BroadcastController', [
    'sortable' => true, 
    'softDelete' => true,
]);
...
// Subscriber
Route::panelResource('subscriber', 'SubscriberController', [
    'except' => [
        'store',
        'create',
        'update',
