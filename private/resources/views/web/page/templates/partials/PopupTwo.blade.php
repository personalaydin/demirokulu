<div class="mfp-popup mfp-popup--md text-color-black">
    <div class="font-size-12 font-size-md-14 text-color-black ">
        ...
        {{-- <h2 class="text-center">DemirOkulu <br>AYDINLATMA METNİ VE AÇIK RIZA BEYANI</h2>
            <h3>1. Konu</h3>
            <br>
            ...
            <p>Veri Sahibi’nin açık rızası aşağıdaki bilgiler dâhil olmak üzere Veri Sahibi’nin kişisel verilerini kapsamaktadır: <br>
                ...
                <ul>
                    ...
                    <li>[] İşbu Beyan kapsamındaki kişisel verilerimin, DemirOkulu tarafından belirtilen amaçlarla işlenmesine ve belirtilen üçüncü kişilere aktarılmasına onay verdiğimi <strong>beyan ederim.</strong></li>
                </ul>
                <br>
                ...
                {{-- <h2 class="text-center">DemirOkulu <br>GENERAL CLARIFICATION NOTICE AND DECLARATION OF EXPLICIT CONSENT</h2>
            <h3>1.Subject </h3>
            <br>
            ...
            <p>This explicit consent comprises any personal data of the Data Subject including the followings: <br>
                ...
                <ul>
                    ...
                    <li>[] I hereby <strong>give consent</strong>for my personal data to be processed within the scope of this Declaration for the purposes specified by DemirOkulu and transfered to the specified third parties.</li>
                </ul>
                <br>
...
{{-- <div class="mfp-popup mfp-popup--md text-color-black">
    <div class="font-size-12 font-size-md-14 text-color-black ">
        ...
        <h2 class="text-center">DemirOkulu <br>BİLGİLENDİRME GRUBU AYDINLATMA METNİ VE AÇIK RIZA BEYANI</h2>
            <h3>1. Konu</h3>
            <br>
            <p>İşbu Beyanın konusu; yazılımımız kullanıcısı hekimlerin ve e-bülten abonesi olmak isteyen kişilerin <strong>(“Veri Sahibi”)</strong> DemirOkulu Giyilebilir Sağlık Ürün Hizmet ve Teknolojileri Sanayi ve Ticaret A.Ş. <strong>(“DemirOkulu”)</strong> ile paylaştığı kişisel verilerinin, 6698 sayılı Kişisel Verilerin Korunması Kanunu başta olmak üzere kişisel verilerin korunmasına ilişkin mevzuat kapsamında DemirOkulu Bilgilendirme Grubu veya e-bülten aboneliği için işlenmesine ilişkin hakları bakımından aydınlatılmasını ve bu kapsamda vereceği açık rızasını düzenlemektir.</p>
            <br>
            <h3>2. Açık Rıza Kapsamındaki Veriler</h3>
            <br>
            <p>Veri Sahibi’nin açık rızası aşağıdaki bilgiler dâhil olmak üzere Veri Sahibi’nin kişisel verilerini kapsamaktadır: <br>
                ...
                <h3>3.Kişisel Verilerin İşlenme Yöntemi, Hukuki Sebebi ve Amacı</h3>
                <br>
                <p>DemirOkulu işbu Beyanın konusu kişisel verileri, ilgilinin haber ve kampanyalardan haberdar olması adına e-bülten aboneliği sağlanması, yenilik ve gelişmeler ile ilgili bilgilendirme yapılması, tanıtım/promosyon faaliyetlerinin yürütülmesi, hizmetlerin geliştirilebilmesi, müşteri memnuniyetinin sağlanması, sözleşmesel ilişkinin yürütülmesi, hizmetler hakkında değerlendirme ve geri bildirim süreçlerinin etkin bir şekilde yürütülmesi, satış ve pazarlama politikalarının sürdürülmesi amaçlarıyla Veri Sahibi’ne e-posta gönderilmesi için elektronik ve/veya fiziksel ortamlarda toplamaktadır. Bu süreçte toplanan kişisel veriler, otomatik ve otomatik olmayan yöntemlerle işlenebilmektedir. DemirOkulu kişisel verilerin işlenmesi bakımından işbu amaç ve dayanağın dışına çıkmayacaktır.</p>
                <br>
                <h3>4. Kişisel Verilerin Aktarımı</h3>
                <p>DemirOkulu yukarıda belirtilen amaçlarla işlediği Veri Sahibi’nin kişisel verilerini, hukuki yükümlülüklerin gerektirdiği durumlarda yetkili ve ilgili kamu kurum ve kuruluşlarına yapılacak olan aktarım dışında hiçbir gerçek veya tüzel kişiye aktarmayacaktır.</p>
                <br>
                <h3>5. Kişisel Verilerin İşlenme Süresi</h3>
                <br>
                <p>DemirOkulu, işlediği kişisel verileri güncel teknolojik yöntemler dâhilinde doğru ve güncel olarak muhafaza etmekte ve yukarıda belirtilen amaçlarla sınırlı sürelerle işlemektedir. DemirOkulu, işlenmesini gerektiren sebeplerin ortadan kalkması hâlinde kişisel verileri re’sen veya Veri Sahibi’nin talebi üzerine silecek, yok edecek veya anonim hâle getirecektir.</p>
                ...
                <h2 class="text-center">DemirOkulu <br>CLARIFICATION NOTICE OF INFORMATION GROUP ON PROCESSING PERSONAL DATA AND DECLARATION OF EXPLICIT CONSENT</h2>
            <h3>1.Subject </h3>
            <br>
