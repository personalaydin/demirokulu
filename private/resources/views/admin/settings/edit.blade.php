        ...
        <div class="portlet light portlet-fit portlet-form bordered">
            ...
            <div class="portlet-body">
                ...
                <form class="validate-form" action="{{ route('admin.settings.update') }}" method="post">
                    ...
                    <div class="form-body">
                        @include('admin.template.components.form.text', [
                            'value' => setting('blog_url'),
                            'type' => 'url',
                            'name' => 'key[blog_url]',
                            'label' => 'Blog URL',
                            'placeholder' => 'Blog sayfasınızın adresini yazın',
                        ])
                        ...
                        @include('admin.template.components.form.text', [
                            ...
                            'type' => 'url',
                            'name' => 'key[social_linkedin]',
                            'label' => 'Linkedin',
                            'icon' => 'fa fa-linkedin',
                            'placeholder' => 'Linkedin profilinizin adresini yazın',
                        ])
                        ...
                        @include('admin.template.components.form.text', [
                            ...
                            'label' => 'Youtube',
                            'icon' => 'fa fa-youtube',
                            'placeholder' => 'Youtube kanalınızın adresini yazın',
                        ])
                    </div>
                    <div class="form-actions">
                        <div class="row">
