...
trait MetaTrait
{
    ...
    public function setMetaTitle()
    {
        if (method_exists($this, 'seoMetaTitle') && !empty($this->seoMetaTitle())) {
            SEOMeta::setTitle($this->seoMetaTitle(), false);

            if ($this->seoMetaTitle()) {
                OpenGraph::setTitle($this->seoMetaTitle().config('seotools.meta.defaults.separator').config('seotools.meta.defaults.title'), false);
            }
            ...
            if ($this->getTitle()) {
                OpenGraph::setTitle($this->getTitle().config('seotools.meta.defaults.separator').config('seotools.meta.defaults.title'), false);
            } else {
                OpenGraph::setTitle($this->getTitle(), false);
            }
        }
    }
