...
class GenFormViewAdmin extends GeneratorCommand
{
    protected $signature = 'make:genFormViewAdmin {name}';
    protected $description = 'Create a new Admin Form View.';
    ...
    {
        return app_path() . '/Console/Stubs/AdminFormView.stub';
    }
    ...
    protected function getPath($name)
    {
        ...
        return 'resources/views/admin/'.lcfirst($this->argument('name')).'/form.blade.php';
