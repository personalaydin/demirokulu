...
class GenCreateEntityTranslation extends GeneratorCommand
{
    protected $signature = 'make:genCreateEntityTranslation {name}';
    ...
    {
        return app_path() . '/Console/Stubs/EntityTranslation.stub';
    }
    ...
    protected function getPath($name)
    {
        ...
        return str_replace('\\', '/', $name).'Translation.php';
    }
