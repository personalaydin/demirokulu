...
class GenWebDetailView extends GeneratorCommand
{
    protected $signature = 'make:genWebDetailView {name}';
    ...
    {
        return app_path() . '/Console/Stubs/WebDetailView.stub';
    }
    ...
    protected function getPath($name)
    {
        ...
        return 'resources/views/web/'.lcfirst($this->argument('name')).'/detail.blade.php';
