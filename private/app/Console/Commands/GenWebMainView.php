...
class GenWebMainView extends GeneratorCommand
{
    protected $signature = 'make:genWebMainView {name}';
    protected $description = 'Create a new Web Main View.';
    protected $type = 'Web Main View';
    protected $ns = '';
    ...
    {
        return app_path() . '/Console/Stubs/WebMainView.stub';
    }
    ...
    protected function getPath($name)
    {
        ...
        return 'resources/views/web/page/templates/'.ucfirst($this->argument('name')).'.blade.php';
    }
